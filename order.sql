...
SELECT 
    o.order_, s.warehouse
FROM
    Order_ o
        JOIN
    Shipment s ON o.order_ = s.order_
        JOIN
    Customer c ON o.cust = c.cust
WHERE
    c.cname = 'Kumar';
...
SELECT 
    ...
    AVG(order_amt) AS avg_order_amt
FROM
    Customer c
    INNER JOIN Order_ o ON c.cust = o.cust
GROUP BY cname;
